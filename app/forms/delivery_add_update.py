...
class DeliveryAddUpdateForm(FlaskForm):
    ...
    def __init__(self, *args,**kwargs):
        ...
        #self.usrLst = UserService()
        #self.clientname.choices = [str(usr.user_id) for usr in self.usrLst.find_all()]
        self.usrLst = []                    # temporaire
        ...
        self.usrLst.append(self.usr0)       # temporaire
        ...
        self.usrLst.append(self.usr1)       # temporaire
        ...
        self.usrLst.append(self.usr2)       # temporaire
        ...
        self.usrLst.append(self.usr3)       # temporaire
        self.clientname.choices = [str(usr.user_id) for usr in self.usrLst]
